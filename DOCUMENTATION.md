# next-advanced-sitemap (v1.3.8) - Technical Documentation and Reference Manual
...
### 5.5 Robots.txt Configuration & Formatting (v1.3.8)
...
#### `buildRobotsText(options)` (v1.3.8)
...
## 8. Version Changelog Highlights (v1.0.0 - v1.3.8)
